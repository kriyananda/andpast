...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .order-buy, .order-sell { font-size: 0.82rem !important; padding: 0.5rem 0.8rem !important; }
...
def plot_pnl(s, height=480):
    ...
    fig.add_vline(x=s['price'],    line_dash='dash', line_color='#ffd166', line_width=1.5,
                  annotation=dict(text=f"Attuale<br>${s['price']}", font_color='#ffd166', bgcolor='#1c1e21'))
    fig.add_vline(x=s['breakeven'], line_dash='dot', line_color='#ffffff', line_width=1,
                  annotation=dict(text=f"Breakeven<br>${s['breakeven']}", font_color='#ffffff', bgcolor='#1c1e21'))
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            title=dict(text='Prezzo ($)', font=dict(size=11)),
            gridcolor='#2e3035', showgrid=True, zeroline=False,
        ...
        legend=dict(
            bgcolor='rgba(0,0,0,0)', font=dict(color='#d0d3d8', size=10),
            orientation='h', yanchor='bottom', y=1.02, xanchor='left', x=0
        ),
        margin=dict(l=55, r=15, t=40, b=50),
        autosize=True,
    )
    return fig
...
def plot_price_history(ticker):
    ...
    fig.update_layout(
        ...
        xaxis=dict(gridcolor='#2e3035', showgrid=True, tickfont=dict(size=9)),
        yaxis=dict(gridcolor='#2e3035', showgrid=True, tickfont=dict(size=9), tickformat='$.0f'),
        legend=dict(
...
<div class="app-header">
    ...
    <div class="app-subtitle">Debit Spread Advisor — Dati in tempo reale · Yahoo Finance</div>
</div>
""", unsafe_allow_html=True)
